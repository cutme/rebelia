...
$jobsCount = wp_count_posts( 'job')->publish;
...
pll_register_string('rebelia', 'Submit your application');
pll_register_string('rebelia', 'Thank you for your application');
pll_register_string('rebelia', 'Join the Rebelia');
pll_register_string('rebelia', "We're a small team based in Katowice. Learn more about working in Rebelia Games.");
pll_register_string('rebelia', 'Apply now');
pll_register_string('rebelia', 'Buy on');
pll_register_string('rebelia', 'Learn more');
pll_register_string('rebelia', 'Stay updated');
pll_register_string('rebelia', 'Stay in the loop with Rebelia news and games updates');
pll_register_string('rebelia', 'Subscribe');
pll_register_string('rebelia', 'Company');
pll_register_string('rebelia', 'Games');
pll_register_string('rebelia', 'Follow us');
pll_register_string('rebelia', 'Rebelia Games');
pll_register_string('rebelia', 'Your E-mail');
pll_register_string('rebelia', 'Open positions');
pll_register_string('rebelia', 'Full time');
pll_register_string('rebelia', 'JunkYard Simulator is Available!');
pll_register_string('rebelia', 'I accept');
pll_register_string('rebelia', 'Latest Press Releases');
pll_register_string('rebelia', 'Read news');
pll_register_string('rebelia', 'Read all news');
