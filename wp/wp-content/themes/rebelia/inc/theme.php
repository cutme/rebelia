...
function cutme_setup() {
	...
	add_image_size( 'already-played', 820, 462, true );
	add_image_size( 'already-played@2x', 1640, 924, true );

	add_image_size( 'already-played-small', 560, 316, true );
	add_image_size( 'already-played-small@2x', 1120, 632, true );
	
	add_image_size( 'avatar-review', 110, 110, true );
	add_image_size( 'avatar-review@2x', 220, 220, true );

	add_image_size( 'avatar-user', 104, 104, true );
	add_image_size( 'avatar-user@2x', 208, 208, true );
	
	add_image_size( 'mechanics', 1104, 622, true );
	add_image_size( 'mechanics@2x', 2208, 1244, true );

    add_image_size( 'news-big', 820, 360, true );
	add_image_size( 'news-big@2x', 1640, 720, true );

	add_image_size( 'news-small', 620, 304, true );
	add_image_size( 'news-small@2x', 1240, 608, true );
	
	add_image_size( 'office', 820, 380, true );
	add_image_size( 'office@2x', 1640, 760, true );
	...
	register_nav_menus( array(
		...
		'Company' => __( 'Company menu', 'cutme' ),
		'Games' => __( 'Games menu', 'cutme' ),
		'Social' => __( 'Social menu', 'cutme' )
	) );
